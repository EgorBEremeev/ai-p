...
<img src="{{ site.baseurl }}/ru/conceptual-model/mdl_AI-P.drawio.svg" alt="Концептуальная архитектура AI-P" style="width: 100%; height: auto;">
</div>
...
[→ Спектр субъектности]({{ site.baseurl }}/ru/subjectivity-spectrum/)
...
| **Ценностный** | Экстрагированные из нижележащих слоев ценности | сеть | Экстракция, эмерджентное возникновение |
...
[→ Спектр субъектности: эволюционные траектории]({{ site.baseurl }}/ru/subjectivity-spectrum/)
...
| **Субъективный Опыт** <span class="entity-id">SubjectiveExperience</span> | Накопленная история переживания бытия субъекта. [→ Спектр субъектности]({{ site.baseurl }}/ru/subjectivity-spectrum/) |
...
| **Функциональная Система** <span class="entity-id">FunctionalSystem</span> | Целостный адаптивный контур, объединяющий часть Коннектома и направленный на достижение цели. [→ Спектр субъектности]({{ site.baseurl }}/ru/subjectivity-spectrum/) |
